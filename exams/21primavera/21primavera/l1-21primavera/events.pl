...
before:- day(D1), day(D2), D1 >= D2, before(E1, E2), writeOneClause([-ed(E1,D1), -ed(E2,D2)]), fail.
before.

allDifferentDaysEvents:- day(D), allDifferentDaysEvents(L), member(E1, L), member(E2, L), E1 \= E2, writeOneClause([-ed(E1,D), -ed(E2,D)]), fail.
